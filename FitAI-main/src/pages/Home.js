...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-50 via-blue-50 to-green-50 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center pt-10">
          <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight mb-6">
            Your AI-Powered Journey to <span className="gradient-text">Optimal Health</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
            Personalized meal plans, adaptive workout routines, and an intelligent AI assistant – all designed for your unique needs.
          </p>
      ...
      {/* Why Choose AI Health? Section (NOW CLICKABLE) */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Personalized Meal Plans Card - Now a Link */}
            <Link to="/features/meal-plans" className="block bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-2xl shadow-lg text-center card-hover border border-gray-100 transition-transform duration-300 hover:scale-105">
              ...
              <p className="text-gray-700">Get AI-generated meal plans tailored to your goals, dietary needs, and preferences. <span className="text-purple-600 font-semibold text-sm block mt-2">Learn More →</span></p>
            </Link>

            {/* Adaptive Workout Routines Card - Now a Link */}
            <Link to="/features/workout-routines" className="block bg-gradient-to-br from-blue-50 to-green-50 p-8 rounded-2xl shadow-lg text-center card-hover border border-gray-100 transition-transform duration-300 hover:scale-105">
              ...
              <p className="text-gray-700">Receive adaptive workout plans that fit your current fitness level, equipment, and schedule. <span className="text-blue-600 font-semibold text-sm block mt-2">Learn More →</span></p>
            </Link>

            {/* AI Chat Assistant Card - Now a Link */}
            <Link to="/features/ai-chat-assistant" className="block bg-gradient-to-br from-green-50 to-purple-50 p-8 rounded-2xl shadow-lg text-center card-hover border border-gray-100 transition-transform duration-300 hover:scale-105">
              ...
              <p className="text-gray-700">Get instant answers to your fitness and nutrition questions from our intelligent AI assistant. <span className="text-green-600 font-semibold text-sm block mt-2">Learn More →</span></p>
            </Link>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-600 via-blue-600 to-green-600">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Join thousands achieving their health goals with AI-powered insights.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/signup"
